...
//본 라우터파일의 기본호출주소: htt://localhost:3000/article로 시작하게
...
- 호출주소: http://localhost:3000/article/create
- 호출방식: Post
- 응답결과: 신규 게시글 DB등록 처리 후 특정 페이지로 이동 또는 특정뷰파일 제공
** 라우팅 주소와 요청방식 2가지 동일해야 해당 라우팅 메소드가 호출되고 실행된다.
*/
router.post('/create',async(req,res)=>{

    // Step1: 사용자가 입력한 폼태그내 입력/선택 데이터 추출하기
    ...
    // Step3: DB게시글 테이블에 상기 article 데이터 등록처리(Insert Into Table명...)
    ...
    // Stpe 4: 등록완료 후 게시글 목록 페이지로 이동시킴

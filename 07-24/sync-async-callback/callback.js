...
//아주 간단한 계산함수 만들기
//fnPlus(a,b)함수에 전달되는 a,b 파라메터(매개변수)를 받아 로직을 처리하고
//결과를 반한하는 함수
function fnPlus(a, b){
    let c = a + b;
...
//콜백함수 개념이해하기
//콜백함수를 이용하면 특정함수내에서 순차적 프로그래밍이 가능
...
//콜백함수를 구현(사용)하는 이유는 해당 기본함수가 실행될 때 기본함수내에서
//전달된 콜백함수를 순차적(동기방식)으로 실행될 수 있게 강제하기 위한 수단으로 사용

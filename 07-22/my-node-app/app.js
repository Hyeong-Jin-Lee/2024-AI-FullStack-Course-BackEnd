...
//서버측에서 전문 로깅처리를 mornan 로거 참조: 잘안씀
...
//샘플 라우터파일로 사용자정보(웹페이지) 요청과 응답에서 샘플제공
var usersRouter = require('./routes/users');

//express메소드를 호출해 nodeapp 객체를 생성한다. 
var app = express();

// 생성된 노드 백엔드 앱에 각종 설정들을 set메소드를 통해 설정
// view engine setup
...
//routes/userjs 라우터 파일의 기본 호출주소 체계를 정의
